...
import { BACKEND_UNAVAILABLE_CODE, BACKEND_UNAVAILABLE_STATUS, type BackendErrorBody } from "@/lib/api/errors";
...
const errorBody = (code: string, message: string, details?: unknown): BackendErrorBody => ({
...
export interface ProxyOptions {
  /** Abort the backend call after this many ms. Analyze runs can be slow, so keep it generous. */
  timeoutMs?: number;
}
